...
@Component({
  selector: 'app-framecalculadora',
  templateUrl: './framecalculadora.page.html',
  styleUrls: ['./framecalculadora.page.scss'],
})
export class FramecalculadoraPage implements OnInit {
  ...
  step2() {
    window.top.location.href = '/appv3/indash/operacion'
    // window.location.href = "/appv3/indash/operacion";
